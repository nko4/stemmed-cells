...
~~~sh
# getting the code
git clone git@github.com:nko4/stemmed-cells.git && cd ./stemmed-cells/

# developing
npm install
npm start

# deploying (to http://stemmed-cells.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@stemmed-cells.2013.nodeknockout.com
ssh root@stemmed-cells.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@stemmed-cells.2013.nodeknockout.com
ssh -i ./id_deploy root@stemmed-cells.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/stemmed-cells" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
